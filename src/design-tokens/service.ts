...
const GENERATED_DOC_BANNER = `<!-- GENERATED by paqad-ai from ${PATHS.DESIGN_TOKENS_FILE} — do not edit. Edit that file, then run \`paqad refresh --design-system\`. -->`;
...
const DESIGN_TOKENS_SOURCE_NOTE =
  "Canonical, hand-edited source of truth for this project's design system. The Markdown files in this folder (tokens.md, components.md, …) are generated from this file by `paqad refresh --design-system` — edit this file, not them.";
