    ...
    stages: {
      ...
      delivery: {
        ...
        instructions: [
          ...
          "On green, the CI gate posts paqad's rendered verification evidence (the same render as the paqad-ai evidence command) to the PR via the host provider, so the deterministic proof lands automatically; a comment_and_stop red posts the same proof showing what blocked it. No evidence file means nothing is posted.",
