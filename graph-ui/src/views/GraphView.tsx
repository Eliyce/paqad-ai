...
/**
 * The existing graph SPA, lifted verbatim from App.tsx. Now mounted under
 * the `/#/graph` route; the dashboard view embeds nothing from here in
 * phase 1 (architecture card opens this route via navigation).
 */
