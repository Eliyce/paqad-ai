...
- "site map retest", "retest the site map", "did the map drift?" <!-- @rule RL-99d8 -->
...
- Never invent a new finding in a retest, and never lower a finding's severity. <!-- @rule RL-0cd3 -->
- Match by stable `SM-` id, not by category or surface label. <!-- @rule RL-d7bb -->
- A surface whose cited evidence no longer resolves is `still-open`, never `fixed`; absence of <!-- @rule RL-e79f -->
