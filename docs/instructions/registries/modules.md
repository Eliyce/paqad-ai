...
| adapter-onboarding  | Adapter Onboarding (LLM platform entry files)| [↗](../../modules/adapter-onboarding/index/summary.md) | claude-code, codex-cli, antigravity, gemini-cli, junie, cursor, github-copilot, windsurf, continue, aider, aiassistant |
