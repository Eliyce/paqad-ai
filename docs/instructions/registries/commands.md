...
| `evidence`      | `src/cli/commands/evidence.ts`    | Render verification evidence as a scannable PR comment (Markdown or JSON); move old spec runs into their bundles (`migrate [--dry-run]`) |
