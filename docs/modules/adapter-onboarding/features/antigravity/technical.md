# Google Antigravity (ANTIGRAVITY.md) — Technical View
...
- CLI entry: `paqad-ai antigravity` (verify exact flag set in the source).
...
- Unit test files that cover `antigravity` directly.
