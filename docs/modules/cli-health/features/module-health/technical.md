# paqad-ai module-health — Technical View
...
- CLI entry: `paqad-ai module health` (verify exact flag set in the source).
...
- Unit test files that cover `module-health` directly.
