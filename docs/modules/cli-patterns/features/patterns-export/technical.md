# patterns export — Technical View
...
- CLI entry: `paqad-ai patterns export` (verify exact flag set in the source).
...
- Unit test files that cover `patterns-export` directly.
