...
- [`expert-notes`](../../runtime/base/skills/expert-notes/SKILL.md) — one runner skill with a lens per pickable expert: reads a brief and writes request-time findings and questions (issue #547). Knows: the brief, its lens.
