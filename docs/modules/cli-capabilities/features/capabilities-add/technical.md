# capabilities add — Technical View
...
- CLI entry: `paqad-ai capabilities add` (verify exact flag set in the source).
...
- Unit test files that cover `capabilities-add` directly.
