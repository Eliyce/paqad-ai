# capabilities remove — Technical View
...
- CLI entry: `paqad-ai capabilities remove` (verify exact flag set in the source).
...
- Unit test files that cover `capabilities-remove` directly.
