# capabilities list / available — Technical View
...
- CLI entry: `paqad-ai capabilities list` (verify exact flag set in the source).
...
- Unit test files that cover `capabilities-list` directly.
