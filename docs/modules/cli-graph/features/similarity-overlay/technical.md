# Similarity & Intelligence Overlays — Technical View

> Module: **Project Graph Command** (`cli-graph`) · Layer: `cli-commands` · Feature slug: `similarity-overlay`
...
- CLI entry: `paqad-ai similarity overlay` (verify exact flag set in the source).
...
- Unit test files that cover `similarity-overlay` directly.
