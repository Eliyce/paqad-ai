# compliance check — Technical View
...
- CLI entry: `paqad-ai compliance check` (verify exact flag set in the source).
...
- Unit test files that cover `compliance-check` directly.
