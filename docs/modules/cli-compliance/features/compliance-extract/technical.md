# compliance extract — Technical View
...
- CLI entry: `paqad-ai compliance extract` (verify exact flag set in the source).
...
- Unit test files that cover `compliance-extract` directly.
