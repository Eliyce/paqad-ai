# compliance patterns — Technical View
...
- CLI entry: `paqad-ai compliance patterns` (verify exact flag set in the source).
...
- Unit test files that cover `compliance-patterns` directly.
