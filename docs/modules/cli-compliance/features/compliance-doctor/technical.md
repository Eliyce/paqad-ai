# compliance doctor — Technical View
...
- CLI entry: `paqad-ai compliance doctor` (verify exact flag set in the source).
...
- Unit test files that cover `compliance-doctor` directly.
