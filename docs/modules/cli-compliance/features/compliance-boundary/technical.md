# compliance boundary — Technical View
...
- CLI entry: `paqad-ai compliance boundary` (verify exact flag set in the source).
...
- Unit test files that cover `compliance-boundary` directly.
