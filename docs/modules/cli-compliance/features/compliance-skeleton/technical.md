# compliance skeleton — Technical View
...
- CLI entry: `paqad-ai compliance skeleton` (verify exact flag set in the source).
...
- Unit test files that cover `compliance-skeleton` directly.
