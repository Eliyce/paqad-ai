# compliance review — Technical View
...
- CLI entry: `paqad-ai compliance review` (verify exact flag set in the source).
...
- Unit test files that cover `compliance-review` directly.
